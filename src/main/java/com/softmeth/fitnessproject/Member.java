...
public class Member implements Comparable<Member> {
    ...
    /** testbed main to test the CompareTo method
        all of the cases can be found in the test design document
    * */
    public static void main(String[] args) {
        Member m1 = new Member("Duke", " Ellington", new Date("2/29" +
                "/2000"),
                new Date("9/30/2023"), Location.FRANKLIN);
        Member m2 = new Member("John", " Doe ", new Date("1/20/2003"),
                new Date("3/30/2021"), Location.BRIDGEWATER);
        System.out.printf(
                "Member 1 is %s and member 2 is %s: their compare " +
                        "is %s\n",
                m1.toString(), m2.toString(), m1.compareTo(m2));

        m1 = new Member("Duke", " Ellington", new Date("2/29/2000"),
                new Date("9/30/2023"), Location.FRANKLIN);
        m2 = new Member("John", " Doe ", new Date("1/20/2003"),
                new Date("3/30/2021"), Location.BRIDGEWATER);
        System.out.printf(
                "Member 1 is %s and member 2 is %s: their compare " +
                        "is %s \n",
                m1.toString(), m2.toString(), m2.compareTo(m1));

        m1 = new Member("Jane", " Doe ", new Date("5/1/1996"),
                new Date("3/30/2023"), Location.EDISON);
        m2 = new Member("John", " Doe ", new Date("1/20/2003"),
                new Date("3/30/2021"), Location.BRIDGEWATER);
        System.out.printf(
                "Member 1 is %s and member 2 is %s: their compare " +
        ...
        m1 = new Member("John", " Doe ", new Date("1/20/2004"),
                new Date("3/30/2021"), Location.BRIDGEWATER);
        m2 = new Member("John", " Doe ", new Date("1/20/2003"),
                new Date("3/30/2021"), Location.BRIDGEWATER);
        System.out.printf(
        ...
        m1 = new Member("John", " Doe ", new Date("1/20/2003"),
                new Date("3/30/2021"), Location.BRIDGEWATER);
        m2 = new Member("John", " Doe ", new Date("1/20/2003"),
                new Date("3/30/2021"), Location.BRIDGEWATER);
        System.out.printf(
